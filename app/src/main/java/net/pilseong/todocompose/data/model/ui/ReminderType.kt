...
enum class ReminderType(val label: Int, val timeInMillis: Long) {
    ...
    TWELVE_HOURS(label = R.string.reminder_twelve_hours,    timeInMillis = 12 * 60 * 60 * 1000L),
    A_DAY(label = R.string.reminder_a_day,              timeInMillis = 24 * 60 * 60 * 1000L),
    TWO_DAYS(label = R.string.reminder_two_days,        timeInMillis = 48 * 60 * 60 * 1000L),
}